...
<div class="form-container">
    <h2>일정 등록하기</h2>
    <form:form commandName="calendar"  id="scheduleInsertForm" action="scheduleInsert.manager" method="post">
        <table>
            <tr>
                <th>회원 이름</th>
                <td>
                    ...
                    <input type="checkbox" name="name" value="공용">
                    <span class="common">공통으로 진행하는 일정</span>
            ...
            <tr>
                <th>시작날짜</th>
                <td>
                    <input type="text" id="start_date" name="start_date" value="<%= request.getParameter("start_date")%>" disabled>
            ...
            <tr>
                <td colspan="2">
                    <input type="submit" value="일정등록하기" class="submit-btn">
                </td>
            </tr>
        </table>
    </form:form>
