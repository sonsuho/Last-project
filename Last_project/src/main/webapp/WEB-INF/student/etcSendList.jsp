...
<script>
    ...
    // 화면 분할
    function openDetail(etc_num,sender_num) {
        var xhr = new XMLHttpRequest();
        xhr.open('GET', 'etcDetail2.student?etc_num=' + etc_num +"&sender_num="+sender_num, true);
        xhr.onload = function() {
            if (xhr.status === 200) {
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" name="myform" action="selectDeleteSend.student">
                        ...
                        <tr>
                            <th><input type="button" value="일괄삭제" onclick="selectDelete()" class="btn btn-sm btn-gradient-danger py-3"></th>
                        </tr>
