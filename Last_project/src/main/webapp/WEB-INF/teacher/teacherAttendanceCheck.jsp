...
<div align="center">
	...
	<br><br>
	<span style="position: absolute; left: 63px; ">퇴근시간</span>
	<span style="position: absolute; left: 128px; ">:</span>
...
<%
    ...
    if(check_flag.equals("")) {
%>

		<!-- 출근하기 Button -->
		<form name="checkInForm" id="checkInForm" action="start.teacher?mem_num=${loginInfo.mem_num}&mem_ip=${loginInfo.mem_ip}&mem_latitude=${loginInfo.mem_latitude}&mem_longitude=${loginInfo.mem_longitude}" method="post">
...
<%
	} else if(check_flag.equals("success")) {
%>
		<!-- 퇴실하기 Button -->

		<form name="checkOutForm" id="checkOutForm" action="fin.teacher?mem_num=${loginInfo.mem_num}&mem_ip=${loginInfo.mem_ip}&mem_latitude=${loginInfo.mem_latitude}&mem_longitude=${loginInfo.mem_longitude}" method="post">
