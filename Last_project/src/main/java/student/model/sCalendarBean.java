...
public class sCalendarBean {
	...
	public sCalendarBean() {
		
	}
	
	

	public sCalendarBean(int cal_num, int lec_num, String mem_num, String lesson_class, String name, String title,
