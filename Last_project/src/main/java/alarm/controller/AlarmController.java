...
import alarm.model.InterAlarmService;
...
public class AlarmController {
	...
	public String getDept(HttpServletRequest request) {
		...
		List<AlarmBean> alarmList = service.getAlarmList(loginInfo.getMem_num());
		
		JSONArray jsonArr = new JSONArray();
		
		for(AlarmBean alarmvo: alarmList) {
	...
	public String getPastAlarmList(HttpServletRequest request) {
		...
		List<AlarmBean> alarmList = service.getPastAlarmList(loginInfo.getMem_num());
	...
	public String getUnreadAlarmCnt(HttpServletRequest request) {
		...
		int cnt = service.getUnreadAlarmCnt(loginInfo.getMem_num());
